...
// Clase Departamento que contiene código, denominación y presupuesto.
@Entity
public class Departamento {
	...
	// Crea un departamento a partir de 2 parámetros.
	public Departamento(String denominacion, double presupuesto) {
		this.denominacion = denominacion;
		this.presupuesto = presupuesto;
	}
	
	// Crea un departamento a partir de 1 parámetro.
